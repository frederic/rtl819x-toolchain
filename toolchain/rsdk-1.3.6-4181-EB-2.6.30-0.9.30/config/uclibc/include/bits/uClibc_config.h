...
#define __KERNEL_HEADERS__ "/opt/cadpc4/tonywu/risc/rlx_linux/wrapper/kernel/linux-2.6.30/include"
...
#define __CROSS_COMPILER_PREFIX__ "rsdk-linux-"
#define __UCLIBC_EXTRA_CFLAGS__ "-march=4181 -EB"
#undef __DODEBUG__
