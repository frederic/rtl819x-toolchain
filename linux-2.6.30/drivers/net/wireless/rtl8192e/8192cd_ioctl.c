...
//	{"oprates_ac",	RFFT_T, _OFFSET_RFFT(dot11SupportedRates_AC), _SIZE_RFFT(dot11SupportedRates_AC), 0x2},
//	{"basicrates_ac",	RFFT_T, _OFFSET_RFFT(dot11BasicRates_AC), _SIZE_RFFT(dot11BasicRates_AC), 0x2},
//#endif	
//#if defined(CONFIG_RTL_8812_SUPPORT) || defined(CONFIG_WLAN_HAL_8881A)  //vht rate 
//	{"update_rainfo",	RFFT_T, _OFFSET_RFFT(update_rainfo), _SIZE_RFFT(update_rainfo), 0x1},
#ifdef FOR_VHT5G_PF2
	{"cca_test",	RFFT_T, _OFFSET_RFFT(use_cca), _SIZE_RFFT(use_cca), 0x0},
	{"cca_rts",	RFFT_T, _OFFSET_RFFT(cca_rts), _SIZE_RFFT(cca_rts), 0x02},
#endif
//	{"cca_rts",	RFFT_T, _OFFSET_RFFT(cca_rts), _SIZE_RFFT(cca_rts), 0x01},	// 1: static, 2: dynamic

// ldpc
	{"rxldpc", RFFT_T, _OFFSET_RFFT(rxldpc), _SIZE_RFFT(rxldpc), 0x00},	
	{"txldpc", RFFT_T, _OFFSET_RFFT(txldpc), _SIZE_RFFT(txldpc), 0x00},	
// Tx Power Diff
