...
#if (defined(CONFIG_RTL_92C_SUPPORT)&&defined(CONFIG_RTL_92D_SUPPORT))||defined(CONFIG_RTL_92D_DMDP)||defined(CONFIG_RTL_DUAL_PCIESLOT_BIWLAN)||(defined(CONFIG_RTL_92C_SUPPORT)&&defined(CONFIG_RTL_8812_SUPPORT))
...
#define	RTL_USED_PCIE_SLOT	0
	...
	#define	RTL_MAX_PCIE_SLOT_NUM	2
		...
		#define RTL_USED_PCIE_SLOT  1			// 8197D demo board: slot 1, QA board: slot 0
#else
		#define	RTL_USED_PCIE_SLOT		0
#endif		
...
#define DRV_RELDATE		"2012-11-23"
#ifdef CONFIG_RTL_8812_SUPPORT
#define DRV_NAME		"RTL8812"
#else
#ifdef CONFIG_RTL_88E_SUPPORT
#define DRV_NAME		"RTL8188ER"
#else
#ifdef LINUX_2_6_22_
#define DRV_NAME		"RTL8192E/RTL8881A"
#else
#define DRV_NAME		"RTL8192E/RTL8881A"
#endif
#endif
...
// MP test
//-------------------------------------------------------------
#if (!defined(CONFIG_RTL8196B_GW_8M) || defined(CONFIG_RTL8196B_GW_MP)) && !defined(__ECOS)
#define MP_TEST
...
#endif
#undef SW_TX_QUEUE
#undef MCAST2UI_REFINE
#undef PREVENT_BROADCAST_STORM
#undef TX_SUPPORT_IPV6_MCAST2UNI
...
//-------------------------------------------------------------
	...
	#define USE_WEP_DEFAULT_KEY
#endif	
	#undef USE_WLAN_TIMER_FOR_RC		/* use wlan nic timer for reoder-control timer */
...
//#undef MCAST2UI_REFINE
//#undef PREVENT_BROADCAST_STORM
#undef RADIUS_ACCOUNTING
#undef WIFI_11N_2040_COEXIST
