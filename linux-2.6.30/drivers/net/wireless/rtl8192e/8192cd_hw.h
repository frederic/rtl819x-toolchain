...
struct rtl8192cd_tx_desc_info {
	...
	struct tx_desc_info	tx_info6[NUM_TX_DESC];
	struct tx_desc_info	tx_info7[NUM_TX_DESC];
	struct tx_desc_info	tx_info8[NUM_TX_DESC];
	struct tx_desc_info	tx_info9[NUM_TX_DESC];
	struct tx_desc_info	tx_info10[NUM_TX_DESC];
	struct tx_desc_info	tx_info11[NUM_TX_DESC];
	struct tx_desc_info	tx_info12[NUM_TX_DESC];
#endif	
};
