...
#define		rfc_AGC_table_select_JAguar		0x82c   // AGC tabel select
#define		bAGC_table_Jaguar		0x3
#define		rRFE_A_control_JAguar		0xcb0  // Path_A RFE cotrol pinmux
#define		rRFE_B_control_JAguar		0xeb0 // Path_B RFE control pinmux
#define		rRFE_A_interface_control_JAguar			0xcb8  // Path_A RFE cotrol
#define		rRFE_B_interface_control_JAguar			0xeb8 // Path_B RFE control
