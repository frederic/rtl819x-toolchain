...
/* Decl of Static init functions */
#ifdef USE_READAHEAD
#define static_decl_vfs extern NTSTATUS vfs_default_init(void); extern NTSTATUS vfs_readahead_init();
#else
...
#define static_init_pdb {  pdb_smbpasswd_init(); }

/* Static init functions */
#define static_init_rpc {  rpc_wkssvc_init(); rpc_srvsvc_init(); }

/* Static init functions */
#ifdef USE_READAHEAD
#define static_init_vfs {  vfs_default_init(); vfs_readahead_init(); }
#else
