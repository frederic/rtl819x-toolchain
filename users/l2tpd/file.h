...
*/
#ifndef DEFAULT_AUTH_FILE
//#define DEFAULT_AUTH_FILE "/etc/ppp/l2tp-secrets"
#define DEFAULT_AUTH_FILE "/etc/ppp/ppp-secrets"
#endif
#ifndef DEFAULT_CONFIG_FILE
#define DEFAULT_CONFIG_FILE "/etc/ppp/l2tpd.conf"
#endif
//#define ALT_DEFAULT_AUTH_FILE "/etc/ppp/l2tp-secrets"

#define ALT_DEFAULT_AUTH_FILE "/etc/ppp/ppp-secrets"
#define ALT_DEFAULT_CONFIG_FILE "/etc/ppp/l2tpd.conf"
#define DEFAULT_PID_FILE "/var/run/l2tpd.pid"
