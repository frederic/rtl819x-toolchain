 ...
 * don't ask for sequencing */
...
#if defined(RTL_L2TP_POWEROFF_PATCH)  //Patch for l2tp re-connet to server(winxp) after power off/on by jiawenjian
	{
		...
		sprintf(l2tp_cmdBuf, "flash set L2TP_PAYLOAD %02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x",
		...
		l2tp_payload[32], l2tp_payload[33], l2tp_payload[34], l2tp_payload[35], l2tp_payload[36], l2tp_payload[37]);
