...
extern void lac_hangup (int cid); // david
extern void lac_disconnect (int tid); //david
...
// david ----------------
		log (LOG_DEBUG, "%s: call disconnect.sh-1!!\n", __FUNCTION__);
		lac_hangup (c);
...
// david ---------------
		log (LOG_DEBUG, "%s: call disconnect.sh-2!!\n", __FUNCTION__);
		lac_hangup (c);
		lac_disconnect (c->container);
		system("disconnect.sh option_l2tp");
//--------------------
...
// david ----------------------
	log (LOG_DEBUG, "%s: call disconnect.sh-3!!\n", __FUNCTION__);
	lac_hangup (c);
	lac_disconnect (c->container);
	destroy_call (c);
	system("disconnect.sh option_l2tp");
