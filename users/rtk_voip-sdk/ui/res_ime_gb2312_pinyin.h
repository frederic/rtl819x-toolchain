#ifndef __RES_IME_GB2312_PINYIN_H__
#define __RES_IME_GB2312_PINYIN_H__

#define PY_SUPRA_INDEX_ENTRY		( 26 * 10 )		/* Level 1: (25) a~z; Level 2: 10 */
#define PY_SUPRA_INDEX_BOUNDARY		164
